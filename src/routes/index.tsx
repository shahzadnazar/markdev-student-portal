...
const router = createBrowserRouter([
  ...
  },
  {
    element: <RequireAuth />,
    children: [
      // The lesson player is immersive: it renders outside the app shell.
      {
        path: "/courses/:courseId/lessons/:lessonId",
        element: page(<LessonPlayerPage />),
      },
      // Full-screen quiz taking, free of shell distractions.
      {
      ...
      },
      {
        ...
        children: [
          ...
          { path: "/courses/:courseId", element: page(<CourseDetailPage />) },
          { path: "/assignments", element: page(<AssignmentsPage />) },
          { path: "/assignments/:assignmentId", element: page(<AssignmentDetailPage />) },
          { path: "/quizzes", element: page(<QuizzesPage />) },
          { path: "/quizzes/:quizId", element: page(<QuizDetailPage />) },
          { path: "/quizzes/:quizId/results/:attemptId", element: page(<QuizResultPage />) },
          { path: "/certificates", element: page(<CertificatesPage />) },
          ...
          { path: "/help/articles/:slug", element: page(<HelpArticlePage />) },
